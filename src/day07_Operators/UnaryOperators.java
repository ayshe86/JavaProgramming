...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println(num2 < 2); //true
        ...
        --a; //pre decrement : decrees the value by 1 right a way
        System.out.println(a);
        System.out.println("----------------------------------");
        int b = 100;
        ...
        int c = 100;
        System.out.println(c++); // post increment : first past to current value then increases the value by one
        ...
        int y = 200;
        System.out.println(y--); //post decrement: first past to current value, then decreases the value by one
